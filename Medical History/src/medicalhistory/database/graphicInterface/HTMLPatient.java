...
public class HTMLPatient extends JFrame {

    
    /**
	 * 
	 */
	private static final long serialVersionUID = -4014825344837798493L;
	private JPanel panel=new JPanel();
    public static XMLManager xmlMan;
    
    public HTMLPatient(Patient a) {
    	xmlMan=new JDBCXMLManager();
    	
        setTitle("HTML patient");
	    ...
	    panel.setLayout(null);
                ...
                try {
                    ...
                    File file = xmlMan.patient2Xml(a);
                    String path= "./xmls/htmlpatient.xslt";
                    ...
                    e1.printStackTrace();
                    JOptionPane.showMessageDialog(null, "Error generating or reading the HTML file.", "Error", JOptionPane.ERROR_MESSAGE);
                }
