...
public VisitInfoDoctor (Visit a, Doctor d,User u) {	
   ...
   // Establecer un diseño de cuadrícula de una sola columna
    ...
    botonCange.setBounds(62, 198, 744, 81);
    ...
    if(a.getVisit_test()!=null) {
     JButton botonTest = new JButton("See other visits fot this test");
    botonTest.setFont(new Font("Tw Cen MT", Font.BOLD, 23));
    botonTest.setBounds(815, 199, 744, 81);
    panel.add(botonTest);
