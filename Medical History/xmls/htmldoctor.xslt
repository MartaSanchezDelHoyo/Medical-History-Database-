...
<div id="main" class="box">
    ...
    <div id="page" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Doctor 1 Info</a></span></h2>
                <table>
                    <tr><th>Doctor ID</th><td><xsl:value-of select="/Doctor/@doctor_id" /></td></tr>
                    <tr><th>Contact</th><td><xsl:value-of select="/Doctor/@contact" /></td></tr>
                    <tr><th>Username</th><td><xsl:value-of select="/Doctor/@username" /></td></tr>
                    <tr><th>Name</th><td><xsl:value-of select="/Doctor/name" /></td></tr>
                    <tr><th>Surname</th><td><xsl:value-of select="/Doctor/surname" /></td></tr>
                    <tr><th>Specialty</th><td><xsl:value-of select="/Doctor/specialty" /></td></tr>
                </table>
                <h2>Hospitals</h2>
                <table>
            ...
            <!-- Article -->
            <div class="article">
              <h2><span><a href="#">Doctor 2 Info</a></span></h2>
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Doctor 3 Info</a></span></h2>
            ...
            <!-- Article -->
            <div class="article">
             	<h2><span><a href="#">Doctor 4 Info</a></span></h2>
